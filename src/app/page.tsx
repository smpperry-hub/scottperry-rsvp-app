    ...
    <main className="flex-1">
      <header className="border-b border-ochre/20 bg-sand/60 px-6 py-16 text-center sm:py-24">
        ...
        <p className="mx-auto mt-4 max-w-md font-sans text-sm leading-7 text-ink/70">
          {isFormalInvite
            ? "November 5-7, 2027 · Palm Springs, California. Let us know if you can make it, and help us plan rooming for the weekend."
            : "November 5-7, 2027 · Palm Springs, California. Let us know if you think you can make it — a formal invite with all the details will follow."}
        </p>
      </header>
